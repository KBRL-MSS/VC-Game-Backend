...
public class FriendController {
  ...
  @GetMapping("/online")
  public ResponseEntity<List<UserStatusDto>> getOnlineFriends(
      @AuthenticationPrincipal UserDetails userDetails) {
    User user =
        userRepository
            .findByUsername(userDetails.getUsername())
  ...
  public ResponseEntity<FriendRequestDto> sendFriendRequest(
      @AuthenticationPrincipal UserDetails userDetails, @RequestBody FriendRequestDto requestDto) {
  ...
  public ResponseEntity<Void> acceptFriendRequest(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable String requestId) {
  ...
  public ResponseEntity<Void> removeFriend(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable String friendId) {
